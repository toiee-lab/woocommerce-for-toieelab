...
if ( ! class_exists( 'ToieeLab_Integration' ) ) :

	class ToieeLab_Integration extends WC_Integration {


		function __construct() {
			global $woocommerce;

			$this->id                 = 'integration-mailerlite-group';
			$this->method_title       = __( 'Mailerlite グループ', 'woocommerce-for-toieelab' );
			$this->method_description = __( 'Mailerliteグループと商品購入者を結びつけるための設定です', 'woocommerce-for-toieelab' );
		...
		public function init_form_fields() {
			$this->form_fields = array(
				'api_key' => array(
					'title'       => __( 'API Key', 'woocommerce-for-toieelab' ),
					'type'        => 'text',
					'description' => __( 'MailerLite Dashboard > Integration > Developer API で取得してください', 'woocommerce-for-toieelab' ),
					'desc_tip'    => true,
					'default'     => '',
				),
			// 'debug' => array(
